...
var showAlert = exports.showAlert = function showAlert(type, message) {
  var markup = "<div class=\"alert\" style=\"background-color:".concat(type, "\">").concat(message, "</div>");
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('green', 'You are logged in!');
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('red', _context.t0.message); //err.response.data.message);
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('green', 'You are logged out!');
            window.setTimeout(function () {
              location.assign('/');
            }, 500);
          }
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('red', 'Error while loggin out!');
        case 10:
        case "end":
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          if (_res.data.status === 'success') {
            (0, _alerts.showAlert)('bg-lime-500', 'Your data are updated!');
            window.setTimeout(function () {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('bg-red-500', res.data.message);
        case 11:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addReccord.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.forgotPassword = exports.addReccord = exports.acctivation = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var setCookieAndGetActivationPage = function setCookieAndGetActivationPage(email) {
  //const email = res.data.data.email;
  var date = toString(Date.now() + 600000);
  document.cookie = "email=".concat(email, ";expires=").concat(date, ",path=/acctivation-page");
  (0, _alerts.showAlert)('green', 'Please acctivate account.');
  window.setTimeout(function () {
...
var addReccord = exports.addReccord = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "http://127.0.0.1:3000/api/v1/".concat(type),
            data: data,
            headers: headers
            // headers: {
            //   'content-type': 'application/json',
        ...
        case 4:
          ...
          if (_res.data.status === 'success') {
            if (type === 'users/signup') {
              setCookieAndGetActivationPage(_res.data.data.email);
            } else {
              (0, _alerts.showAlert)('bg-lime-400', 'Added');
              window.setTimeout(function () {
                location.reload();
              }, 200);
            }
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('bg-red-300', _context.t0.response.data.message);
        case 11:
        case "end":
          return _context.stop();
      }
  ...
  return function addReccord(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var acctivation = exports.acctivation = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(acctivationCode) {
    var email, _res2;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 7:
          ...
          if (_res2.data.status === 'success') {
            (0, _alerts.showAlert)('green', 'Welcome.');
            window.setTimeout(function () {
              location.assign('/account');
            }, 200);
          }
        ...
        case 11:
          _context2.prev = 11;
          _context2.t0 = _context2["catch"](0);
          (0, _alerts.showAlert)('red', _context2.t0.response.data.message);
        case 14:
        case "end":
          return _context2.stop();
      }
  ...
  return function acctivation(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          if (_res3.data.status === 'success') {
            (0, _alerts.showAlert)('bg-lime-500', 'email is sent!');
            setCookieAndGetActivationPage(_res3.data.data.email);
          }
          _context3.next = 10;
          break;
        case 7:
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateReccord.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateReccord = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var updateReccord = exports.updateReccord = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(endpoint, data, id) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:3000/api/v1/".concat(endpoint, "/").concat(id),
            data: data
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('green', 'Reccord updated');
          }
          _context.next = 11;
          break;
        case 7:
          ...
          (0, _alerts.showAlert)('red', _context.t0.response.data.message);
        case 11:
        case "end":
          return _context.stop();
      }
  ...
  return function updateReccord(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"appendToFormData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.appendInputValueFields = exports.appendImagesToFormData = void 0;
var appendInputValueFields = exports.appendInputValueFields = function appendInputValueFields(formData, inputFields) {
  inputFields.forEach(function (inputField) {
    formData.append(Object.keys(inputField)[0], document.getElementById(Object.values(inputField)[0]).value);
  });
};
var appendImagesToFormData = exports.appendImagesToFormData = function appendImagesToFormData(formData, formDataName) {
  var indexFlag = 0;
  for (var _len = arguments.length, images = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
    images[_key - 2] = arguments[_key];
  }
  images.forEach(function (image, index) {
    if (document.getElementById(image).files[0]) {
      formData.append(formDataName, document.getElementById(image).files[0]);
      indexFlag |= Math.pow(2, index);
    }
  });
  return indexFlag;
};
...
//   }
},{}],"deleteReccord.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteReccords = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var deleteReccords = exports.deleteReccords = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(endpoint, reccordsToDelete) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:3000/api/v1/".concat(endpoint),
            data: {
              reccordsToDelete: reccordsToDelete
            },
            headers: {
              'content-type': 'application/json'
            }
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('green', 'Reccords are removed');
            window.setTimeout(function () {
              location.reload();
            }, 200);
          }
  ...
  return function deleteReccords(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.deacctivateReccords = exports.addReview = exports.acctivateReccords = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var deacctivateReccords = exports.deacctivateReccords = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(endpoint, reccordsToDeacctivate) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:3000/api/v1/".concat(endpoint, "/deacctivate"),
            data: {
              reccordsToDeacctivate: reccordsToDeacctivate
            }
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('green', 'reccords are deactivated');
            window.setTimeout(function () {
              location.reload();
            }, 200);
          }
  ...
  return function deacctivateReccords(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var acctivateReccords = exports.acctivateReccords = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(endpoint, reccordsToAcctivate) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:3000/api/v1/".concat(endpoint, "/acctivate"),
            data: {
              reccordsToAcctivate: reccordsToAcctivate
            }
          });
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('green', 'reccords are acctivated');
            window.setTimeout(function () {
              location.reload();
            }, 200);
          }
  ...
  return function acctivateReccords(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var addReview = exports.addReview = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('green', 'review is added');
            window.setTimeout(function () {
              location.assign("".concat(data.aboutItem));
            }, 200);
          }
          _context3.next = 10;
          break;
        case 7:
          _context3.prev = 7;
          _context3.t0 = _context3["catch"](0);
          (0, _alerts.showAlert)('red', _context3.t0.response.data.message);
        case 10:
        case "end":
          return _context3.stop();
      }
  ...
  return function addReview(_x5) {
    return _ref3.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"selectToDelete.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.selectAndDischarge = void 0;
var _deleteReccord = require("./deleteReccord");
var _deactivate = require("./deactivate");
var selectAndDischarge = exports.selectAndDischarge = function selectAndDischarge(selectedButton, reccords, reccordsStatus) {
  var reccordsCheckboxes = document.getElementsByClassName("".concat(reccords, "-checkbox"));
  var reccordsIds = [];
  for (var i = 0; i < reccordsCheckboxes.length; i++) {
  ...
  if (!reccordsIds.length) {
    document.getElementById('select-warrning').textContent = 'No reccords selected.';
    setTimeout(function () {
      document.getElementById('select-warrning').textContent = '';
    }, 1500);
  } else {
    reccordsStatus === 'acctivate' ? (0, _deactivate.acctivateReccords)(reccords, reccordsIds) : reccordsStatus === 'deacctivate' ? (0, _deactivate.deacctivateReccords)(reccords, reccordsIds) : reccordsStatus === 'delete' ? (0, _deleteReccord.deleteReccords)(reccords, reccordsIds) : document.getElementById('select-warrning').textContent = 'Error. Please try again';
  }
};
},{"./deleteReccord":"deleteReccord.js","./deactivate":"deactivate.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _axios = _interopRequireDefault(require("axios"));
var _login = require("./login");
var _updateUserData = require("./updateUserData");
var _addReccord = require("./addReccord");
var _updateReccord = require("./updateReccord");
var _appendToFormData = require("./appendToFormData");
var _selectToDelete = require("./selectToDelete");
var _this = void 0;
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
...
var acctivationForm = document.getElementById('acctivationForm');
var updatePasswordForm = document.getElementById('passwordForm');
var currentImage = document.getElementById('currentImage');
var addItemForm = document.getElementById('addItemForm');
var updateItemForm = document.getElementById('updateItemForm');
var selectReviews = document.getElementById('select-reviews');
var disableUsersBtn = document.getElementById('disable-users');
var enableUsersBtn = document.getElementById('enable-users');
var enableUsersDeleteBtn = document.getElementById('enable-users-delete');
var disableItemsBtn = document.getElementById('disable-items');
var enableItemsBtn = document.getElementById('enable-items');
var enableItemsDeleteBtn = document.getElementById('enable-items-delete');
var disableReviewsBtn = document.getElementById('disable-reviews');
var enableReviewsBtn = document.getElementById('enable-reviews');
var enableReviewsDeleteBtn = document.getElementById('enable-reviews-delete');
...
if (hamburgerBtn) {
  hamburgerBtn.addEventListener('click', function (event) {
    document.getElementById('hamburger-links').style.display = document.getElementById('hamburger-links').style.display === 'none' ? 'block' : 'none';
  });
}
if (loginBtn) {
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            event.preventDefault();
            document.getElementById('changePassword').textContent = 'updating password...';
...
if (forgotPasswordBtn) {
  forgotPasswordBtn.addEventListener('click', function (event) {
    var email = document.getElementById('email').value;
    (0, _addReccord.forgotPassword)(email);
  });
}
if (signinForm) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            (0, _appendToFormData.appendInputValueFields)(formData, [{
              name: 'signinName'
            }, {
              email: 'signinEmail'
            }, {
            ...
            formData.append('photo', document.getElementById('photo').files[0]);
            _context2.next = 7;
            return (0, _addReccord.addReccord)('users/signup', formData);
          case 7:
          case "end":
            return _context2.stop();
        }
...
if (acctivationForm) {
  acctivationForm.addEventListener('submit', function (event) {
    event.preventDefault();
    document.getElementById('acctivateBtn').textContent = 'acctvating...';
    var acctivationCode = document.getElementById('acctivationCode').value;
    (0, _addReccord.acctivation)(acctivationCode);
  });
}
if (disableUsersBtn) {
  disableUsersBtn.addEventListener('click', function () {
    (0, _selectToDelete.selectAndDischarge)(this, 'users', 'deacctivate');
  });
}
if (enableUsersBtn) {
  enableUsersBtn.addEventListener('click', function () {
    (0, _selectToDelete.selectAndDischarge)(_this, 'users', 'acctivate');
  });
}
if (enableUsersDeleteBtn) {
  enableUsersDeleteBtn.addEventListener('click', function () {
    var deleteUsersBtn = document.getElementById('delete-users-final');
    deleteUsersBtn.style.display = 'inline-block';
    if (deleteUsersBtn) {
      deleteUsersBtn.addEventListener('click', function () {
        (0, _selectToDelete.selectAndDischarge)(this, 'users', 'delete');
      });
    }
  });
}
if (disableItemsBtn) {
  disableItemsBtn.addEventListener('click', function () {
    (0, _selectToDelete.selectAndDischarge)(this, 'items', 'deacctivate');
  });
}
if (enableItemsBtn) {
  enableItemsBtn.addEventListener('click', function () {
    (0, _selectToDelete.selectAndDischarge)(_this, 'items', 'acctivate');
  });
}
if (enableItemsDeleteBtn) {
  enableItemsDeleteBtn.addEventListener('click', function () {
    var deleteItemsBtn = document.getElementById('delete-items-final');
    deleteItemsBtn.style.display = 'inline-block';
    if (deleteItemsBtn) {
      deleteItemsBtn.addEventListener('click', function () {
        (0, _selectToDelete.selectAndDischarge)(this, 'items', 'delete');
      });
    }
  });
}
if (disableReviewsBtn) {
  disableReviewsBtn.addEventListener('click', function () {
    (0, _selectToDelete.selectAndDischarge)(this, 'reviews', 'deacctivate');
  });
}
if (enableReviewsBtn) {
  enableReviewsBtn.addEventListener('click', function () {
    (0, _selectToDelete.selectAndDischarge)(_this, 'reviews', 'acctivate');
  });
}
if (enableReviewsDeleteBtn) {
  enableReviewsDeleteBtn.addEventListener('click', function () {
    var deleteReviewsBtn = document.getElementById('delete-reviews-final');
    deleteReviewsBtn.style.display = 'inline-block';
    if (deleteReviewsBtn) {
      deleteReviewsBtn.addEventListener('click', function () {
        (0, _selectToDelete.selectAndDischarge)(this, 'reviews', 'delete');
      });
    }
  });
}
if (currentImage) {
  var selectedPhoto = document.getElementById('photo');
  if (selectedPhoto) {
    selectedPhoto.addEventListener('change', function () {
...
if (addItemForm) {
  addItemForm.addEventListener('submit', function (event) {
    ...
    formData.append('uploadedCoverImage', document.getElementById('itemCoverImage').files[0]);
    var otherImagesFlag = (0, _appendToFormData.appendImagesToFormData)(formData, 'otherUploadedImages', 'otherImage0', 'otherImage1', 'otherImage2');
    formData.append('otherImagesFlag', otherImagesFlag);
    (0, _addReccord.addReccord)('items', formData);
  });
}
if (updateItemForm) {
  updateItemForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var id = updateItemForm.dataset.id;
    var formData = new FormData();
    (0, _appendToFormData.appendInputValueFields)(formData, [{
      itemName: 'itemName'
    }, {
    ...
    var otherImagesFlag = (0, _appendToFormData.appendImagesToFormData)(formData, 'otherUploadedImages', 'otherImage0', 'otherImage1', 'otherImage2');
    formData.append('otherImagesFlag', otherImagesFlag);
    (0, _updateReccord.updateReccord)('items', formData, id);
  });
}
if (userReview) {
  userReview.addEventListener('submit', function (event) {
    event.preventDefault();
    var formData = new FormData();
    var reviewInput = document.getElementById('leftReview');
    ...
    (0, _addReccord.addReccord)('reviews', formData);
  });
}
...
//   });
// }
},{"axios":"../../node_modules/axios/index.js","./login":"login.js","./updateUserData":"updateUserData.js","./addReccord":"addReccord.js","./updateReccord":"updateReccord.js","./appendToFormData":"appendToFormData.js","./selectToDelete":"selectToDelete.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
